...
'actions'=>array('index','view','asociarapartamento'),
'users'=>array('*'),
),
array('allow', // allow authenticated user to perform 'create' and 'update' actions
'actions'=>array('create','update','asociarapartamento'),
'users'=>array('@'),
),
array('allow', // allow admin user to perform 'admin' and 'delete' actions
'actions'=>array('admin','delete','asociarapartamento'),
'users'=>array('admin'),
),
...
public function actionAsociarApartamento()
{
	...
	if(isset($_GET['Edificio']))
		...
		$this->render('asociarapartamento',array(
		'model'=>$model,
		//'edificio'=>$edificio
	));
}
